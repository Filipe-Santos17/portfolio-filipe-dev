...
export const SunIcon = ({ className = "" }: TypeIcon) => (
  <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className={`w-6  h-6 ${className}`}>
...
export const MoonIcon = ({ className = "" }: TypeIcon) => (
  <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" className={`w-6 h-6 ${className}`}>
